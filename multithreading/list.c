...
/**
 * node_create - Creates a node struct and initializes it
 *
 * @content: Address of the custom content to store in node
 *
...
/**
 * list_init - Initializes a list struct
 *
 ...
 *
 * @list:      Pointer to the list struct to destroy the content of
